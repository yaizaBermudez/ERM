...
%-----------------------
h18 = figure;
[pos18] = plotNQz(h18,lamb, ...
                            [bt1z1,bt2z1,bt3z1,bt4z1], ...
                            [bt1z1,bt1z1,bt2z1,bt2z1,bt3z1,bt3z1,bt4z1,bt4z1], ...
                            [zeros(4,100)],{'1'},PlotStd);
...
function [pos] = plotERMSenT1vsT2(h,lamb,R,Mm,Std,z,varargin)
    ...
    for i=1:n
        ...
        plot(lamb,R(:,i),col{i},'LineStyle',lin{i},'LineWidth',2);
        ylim([ymin,ymax]);
        if i ==1
            hold on;
        end
